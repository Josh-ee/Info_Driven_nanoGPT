...
"""
python data/math_5-7-as_even/prepare.py

python train.py config/train_math_5-7_as3.py

python sample.py --out_dir=out-math-5-7-as_3 --start=FILE:prompt_75.txt
python sample.py --out_dir=out-math-5-7-as_3 --start=FILE:prompt_57.txt

python sample.py --out_dir=out-math-5-7-as_3 --start=FILE:prompt_75-.txt
python sample.py --out_dir=out-math-5-7-as_3 --start=FILE:prompt_57-.txt

python sample.py --out_dir=out-math-5-7-as_3 --start=FILE:prompt.txt
...
saving checkpoint to out-math-5-7-as_3
"""

dataset = 'math_5-7-as_even'


out_dir = 'out-math-5-7-as_3'
