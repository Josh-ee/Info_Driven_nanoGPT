...
python train.py config/train_math_5-7_as.py

python sample.py --out_dir=out-math-5-7-as --start=FILE:prompt_75.txt
python sample.py --out_dir=out-math-5-7-as --start=FILE:prompt_57.txt

python sample.py --out_dir=out-math-5-7-as --start=FILE:prompt_75-.txt
python sample.py --out_dir=out-math-5-7-as --start=FILE:prompt_57-.txt

python sample.py --out_dir=out-math-5-7-as --start=FILE:prompt.txt
